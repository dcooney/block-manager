...
/* harmony import */ var _Global_SearchResults__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../Global/SearchResults */ "./src/js/components/Global/SearchResults.js");
/* harmony import */ var _components_Category__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/Category */ "./src/js/components/Blocks/components/Category.js");
/* harmony import */ var _components_Sidebar__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/Sidebar */ "./src/js/components/Blocks/components/Sidebar.js");
...
function Blocks(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, loading ? /*#__PURE__*/React.createElement(_Global_Loader__WEBPACK_IMPORTED_MODULE_8__["default"], {
    ...
    callback: function callback() {
      return (0,_functions_export__WEBPACK_IMPORTED_MODULE_4__.exportHook)(exportModalRef === null || exportModalRef === void 0 ? void 0 : exportModalRef.current, 'blocks');
    },
    total: disabledBlocks === null || disabledBlocks === void 0 ? void 0 : disabledBlocks.length,
  ...
  }, /*#__PURE__*/React.createElement(_Global_SearchResults__WEBPACK_IMPORTED_MODULE_11__["default"], {
    data: search,
    callback: function callback() {
    ...
    }, !!(category !== null && category !== void 0 && (_category$blocks = category.blocks) !== null && _category$blocks !== void 0 && _category$blocks.length) && /*#__PURE__*/React.createElement(_components_Category__WEBPACK_IMPORTED_MODULE_12__["default"], {
      data: category,
...
function Block(_ref) {
  ...
  var intro = variation ? sprintf(
  // translators: Parent block slug.
  (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('%s Block Variation:', 'block-manager'), prefix) : "".concat(title, ":");
  return /*#__PURE__*/React.createElement("button", {
    ...
    className: classnames__WEBPACK_IMPORTED_MODULE_2___default()('item block-button', disabledClass, filteredClass, variation ? 'is-variation' : null),
    "data-id": name,
    "data-category": category,
    onClick: function onClick(e) {
      return click(e);
    },
    title: "".concat(intro, " ").concat(description)
...
function Category(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.Fragment, {
      ...
      disabledBlocks: disabledBlocks,
      filteredBlocks: filteredBlocks
    }), !!(block !== null && block !== void 0 && (_block$variations = block.variations) !== null && _block$variations !== void 0 && _block$variations.length) && _constants__WEBPACK_IMPORTED_MODULE_1__.variationBlocks.includes(block === null || block === void 0 ? void 0 : block.name) && (block === null || block === void 0 ? void 0 : block.variations.map(function (variation) {
      var variationData = _objectSpread(_objectSpread({}, variation), {}, {
        name: "variation;".concat(block === null || block === void 0 ? void 0 : block.name, ";").concat(variation === null || variation === void 0 ? void 0 : variation.name),
        prefix: block === null || block === void 0 ? void 0 : block.title,
        variation: block === null || block === void 0 ? void 0 : block.name
      });
      return /*#__PURE__*/React.createElement(_Block__WEBPACK_IMPORTED_MODULE_2__["default"], {
        key: index + (variation === null || variation === void 0 ? void 0 : variation.name),
        data: variationData,
        toggleBlock: toggleBlock,
        disabledBlocks: disabledBlocks,
        filteredBlocks: filteredBlocks
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _functions_scrollToElement__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../functions/scrollToElement */ "./src/js/functions/scrollToElement.js");
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
...
function Sidebar(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "filtered"
  }))), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Filtered', 'block-manager')))), /*#__PURE__*/React.createElement(_Global_Search__WEBPACK_IMPORTED_MODULE_1__["default"], {
    callback: search
  }), /*#__PURE__*/React.createElement("div", {
    className: "gbm-cta"
    ...
    return /*#__PURE__*/React.createElement(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.Fragment, {
      ...
      onClick: function onClick() {
        var _category$info2;
        return (0,_functions_scrollToElement__WEBPACK_IMPORTED_MODULE_4__["default"])("block-".concat(category === null || category === void 0 || (_category$info2 = category.info) === null || _category$info2 === void 0 ? void 0 : _category$info2.slug));
      }
...
/* harmony import */ var _components_Block__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/Block */ "./src/js/components/Categories/components/Block.js");
/* harmony import */ var _components_Sidebar__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/Sidebar */ "./src/js/components/Categories/components/Sidebar.js");
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
function _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }
...
function Categories(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, loading ? /*#__PURE__*/React.createElement(_Global_Loader__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...
    updatedBlocksOffset: (0,_functions_helpers__WEBPACK_IMPORTED_MODULE_3__.categoryOffsetCount)(blockCategories, disabled_blocks, block_names),
    filteredBlocksOffset: (0,_functions_helpers__WEBPACK_IMPORTED_MODULE_3__.categoryOffsetCount)(filteredCategories, disabled_blocks, block_names)
  }), /*#__PURE__*/React.createElement("div", {
    className: "gbm-blocks"
  }, /*#__PURE__*/React.createElement("div", {
    className: "gbm-block-group"
    ...
    return /*#__PURE__*/React.createElement(_components_Block__WEBPACK_IMPORTED_MODULE_10__["default"], {
...
function Sidebar(_ref) {
  ...
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("strong", null, filtered - filteredBlocksOffset))), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Filtered', 'block-manager')))), /*#__PURE__*/React.createElement(_Global_Search__WEBPACK_IMPORTED_MODULE_2__["default"], {
    callback: search
  }), /*#__PURE__*/React.createElement("div", {
    className: "gbm-cta"
...
/* harmony import */ var _components_Sidebar__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/Sidebar */ "./src/js/components/Patterns/components/Sidebar.js");
/* harmony import */ var _functions_blocks__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../functions/blocks */ "./src/js/functions/blocks.js");
/* harmony import */ var _Global_SearchResults__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../Global/SearchResults */ "./src/js/components/Global/SearchResults.js");
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
function Patterns() {
  ...
  var _countDisabledBlocks = (0,_functions_blocks__WEBPACK_IMPORTED_MODULE_12__.countDisabledBlocks)(allPatterns, disabledPatterns, filteredPatterns),
    disabledCount = _countDisabledBlocks.disabledCount,
    filteredCount = _countDisabledBlocks.filteredCount;
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, loading ? /*#__PURE__*/React.createElement(_Global_Loader__WEBPACK_IMPORTED_MODULE_7__["default"], {
    ...
    className: "gbm-blocks"
  }, /*#__PURE__*/React.createElement(_Global_SearchResults__WEBPACK_IMPORTED_MODULE_13__["default"], {
    data: search,
    callback: function callback() {
      return searchHandler('');
    },
...
function Sidebar(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    callback: setDisabled
  }))), /*#__PURE__*/React.createElement(_Global_Search__WEBPACK_IMPORTED_MODULE_4__["default"], {
    callback: search,
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Search Block Patterns', 'block-manager')
  }), /*#__PURE__*/React.createElement("div", {
    className: "gbm-cta"
...
/* harmony export */   variationBlocks: function() { return /* binding */ variationBlocks; }
/* harmony export */ });
...
var variationBlocks = ['core/embed'];
...
/* harmony export */   countDisabledBlocks: function() { return /* binding */ countDisabledBlocks; },
/* harmony export */   getAllBlocksAndVariations: function() { return /* binding */ getAllBlocksAndVariations; },
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ scrollToElement; }
/* harmony export */ });
/**
